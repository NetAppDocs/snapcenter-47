...
* image:../media/controller_licensed_icon.gif[controller license icon] indicates that a SnapManager Suite license is installed on a FAS or AFF primary storage system.
* image:../media/controller_not_licensed_icon.gif[controller not licensed icon] indicates that a SnapManager Suite license is not installed on a FAS or AFF primary storage system.
...
+
image::../media/nss_controller_license_select.gif[select controller license]
+
...
+
For information about the cmdlets, see https://docs.netapp.com/us-en/snapcenter-cmdlets-47/index.html[SnapCenter Software Cmdlet Reference Guide^].
