...
image::../media/sc-F5-configure-workflow.gif[configure ha using f5]
...
+
For more information, see https://docs.netapp.com/us-en/snapcenter-cmdlets-47/index.html[SnapCenter Software Cmdlet Reference Guide^].
