...
+
image::../media/nss_license_selection.gif[license]
...
. In the License section of the Software page, click *Add* (image:../media/add_policy_from_resourcegroup.gif[add policy from resource group]).
