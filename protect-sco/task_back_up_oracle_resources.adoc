...
. In the Verification page, perform the following steps:
 ...
 .. Click image:../media/add_policy_from_resourcegroup.gif[add policy from resource group] in the Configure Schedules column to configure the verification schedule for all of the schedule types of the policy.
